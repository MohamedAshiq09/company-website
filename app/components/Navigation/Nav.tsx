...
function Nav({ openNav }: Props) {
  ...
  return (
    <div className="h-[12vh] bg-black shadow-md w-full mx-auto rounded-b-3xl px-4 sm:px-6 lg:px-8 bg-opacity-30 backdrop-blur-md  shadow-lg fixed top-0 left-0 right-0 z-50">
