...
function Nav({ openNav }: Props) {
  ...
  return (
    <div className="h-[12vh] bg-gradient-to-r from-black via-gray-900 to-gray-900 w-full mx-auto rounded-b-3xl px-4 sm:px-6 lg:px-8 bg-opacity-30 backdrop-blur-lg  shadow-lg fixed top-0 left-0 right-0 z-50">
        ...
        <ul className="hidden lg:flex items-center space-x-10">
          ...
          <li className="relative text-[18px] font-bold text-red-400 flex items-center">
            <button onClick={toggleAboutDropdown} className="flex items-center focus:outline-none">
              Who we are
              <ChevronDownIcon
                className={`w-5 h-5 text-red-400 ml-1 transform transition-transform duration-500 ${
              ...
              {isAboutOpen && (
                <motion.div
                  ...
                  <div className="grid grid-cols-3 gap-8">
                    ...
                    >
                      <h4 className="font-semibold text-lg mb-4 text-gray-500">
                        Our Organization
                      </h4>
